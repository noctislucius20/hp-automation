...
def run_jobs():
   ...
   try:
      ...
      jobs_service.run_job(sensor_id=data.get('sensor_id'), ip_address=data.get('ip_address'), honeypot=data.get('honeypot'))
...
def get_job_log():
   ...
   try:
      ...
      jobs_service = JobsService()
      job_logs = jobs_service.get_log(workflow_job_id=data.get('workflow_job_id'))
